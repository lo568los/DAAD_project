    ...
    for theta in theta_list:
        for theta_k in thetak_list:
            if theta_k > theta:
                ...
                data1 = np.loadtxt(f"scaled_codes/data/N = 6, theta = {round(theta,2)}, theta_k = {round(theta_k,2)}_h.txt")
                data2 = np.loadtxt(f"scaled_codes/data/N = 10, theta = {round(theta,2)}, theta_k = {round(theta_k,2)}_h.txt")
