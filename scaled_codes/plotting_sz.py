...
plt.plot(range(max_trotter_steps),sz_vals4, "b-", label = "N=10, FS Anisotropic")
plt.plot(range(max_trotter_steps),sz_vals3, "c-", label = "N=10, FS Isotropic")
...
plt.savefig(f"scaled_codes/plots2/Sz plot_FS_compiso", dpi =500)
plt.close()
